...
def main(_):
    ...
    if use_wandb:
        project_name = f"{general_args.wandb_project}{env_args.ndim}_{algo_args.name}_{algo_args.loss_type}_{algo_args.alpha}"
        wandb.init(project=project_name)
        wandb.config.update(general_args.to_dict())
        wandb.config.update(env_args.to_dict())
        wandb.config.update(algo_args.to_dict())
