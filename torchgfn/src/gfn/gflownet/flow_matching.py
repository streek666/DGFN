...
class FMGFlowNet(GFlowNet):
    ...
    def __init__(self, logF: DiscretePolicyEstimator, alpha: float = 1.0, **kwargs):
    ...
    def flow_matching_loss(
        self, states: DiscreteStates, on_pf=True
        ...
        return self.loss_fn(log_incoming_flows, log_outgoing_flows, on_pf=on_pf)

    def reward_matching_loss(self, terminating_states: DiscreteStates, on_pf=True) -> TT[0, float]:
        ...
        return self.loss_fn(terminating_log_edge_flows, log_rewards, on_pf=on_pf)
