...
from gfn.loss import F_alpha, G_alpha, H_alpha, G_Loss, F_Loss
...
class GFlowNet(nn.Module):
    ...
    def __init__(self, loss_fn=None):
        super().__init__()
        self.loss_fn = loss_fn if loss_fn is not None else G_Loss(G_alpha())
...
class PFBasedGFlowNet(GFlowNet):
    ...
    def __init__(self, pf: GFNModule, pb: GFNModule, on_policy: bool = False, **kwargs):
